...
export const metadata: Metadata = {
  ...
  description: "Privacy practices and data handling overview for Kamfe Smile Care Lab website visitors.",
};
    ...
    <div className="py-14">
      <Container className="max-w-4xl">
        ...
        <p className="mt-6 text-sm leading-7 text-slate-700">
          This website provides informational content about Kamfe Smile Care Lab services. We do not collect sensitive
